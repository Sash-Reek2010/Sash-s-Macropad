...
##Features
It has four main keys for wasd and two more for the spacebar and e. It also has an OLED which is nice to have! And a bunch of neopixels for the fun! The outer case is 3d printed and it hosts the pcb inside really well! 
